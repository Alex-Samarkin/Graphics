...
Run:
    uv run python chapters/chapter_03_distributions/ch03_04_boxplot_group_comparison.py
...
FIGURE_ID = "ch03_04_boxplot_group_comparison"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 3.4. Тезис: boxplot удобен для компактного сравнения
        распределений в нескольких группах.

    EN:
        Subsection 3.4. Thesis: boxplots are useful for compact comparison
        of distributions across several groups.
    """
    ...
    ax.set_title("Сравнение распределений с помощью boxplot")
