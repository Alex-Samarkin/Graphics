...
Run:
    uv run python chapters/chapter_03_distributions/ch03_05_box_strip_combo.py
...
FIGURE_ID = "ch03_05_box_strip_combo"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 3.5. Тезис: практический "золотой стандарт" для групп:
        показать индивидуальные точки и статистическую сводку вместе.

    EN:
        Subsection 3.5. Thesis: a practical gold standard for group plots:
        show individual points and summary statistics together.
    """
    ...
    ax.set_title("Boxplot + индивидуальные наблюдения")
