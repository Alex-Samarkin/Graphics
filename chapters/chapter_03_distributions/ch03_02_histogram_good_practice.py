...
FIGURE_ID = "ch03_02_histogram_good_practice"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 3.2. Тезис: хорошая гистограмма показывает форму
        распределения, имеет оси с единицами и не перегружена декором.

    EN:
        Subsection 3.2. Thesis: a good histogram shows the distribution
        shape, has axes with units, and avoids decorative clutter.
    """
    ...
    ax.set_title("Распределение систолического артериального давления")
    sns.despine(ax=ax)
