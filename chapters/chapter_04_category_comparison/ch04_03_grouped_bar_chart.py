...
Run:
    uv run python chapters/chapter_04_category_comparison/ch04_03_grouped_bar_chart.py
...
FIGURE_ID = "ch04_03_grouped_bar_chart"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 4.3. Тезис: сгруппированные столбцы полезны для
        сравнения категорий внутри нескольких групп.

    EN:
        Subsection 4.3. Thesis: grouped bars are useful for comparing
        categories within multiple groups.
    """
