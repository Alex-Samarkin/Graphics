...
FIGURE_ID = "ch04_02_pointplot_ci_alternative"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 4.2. Тезис: pointplot часто лучше столбцов средних,
        потому что акцентирует оценку и неопределённость, а не площадь столбца.

    EN:
        Subsection 4.2. Thesis: a pointplot is often better than bars of means
        because it emphasizes the estimate and uncertainty, not bar area.
    """
    ...
    ax.set_title("Pointplot: среднее и 95% доверительный интервал")
