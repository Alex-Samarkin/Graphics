...
Run:
    uv run python chapters/chapter_07_medical_special_plots/ch07_03_forest_plot_basic.py
...
FIGURE_ID = "ch07_03_forest_plot_basic"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 7.3. Тезис: forest plot показывает оценки эффекта,
        доверительные интервалы и вес исследований в мета-анализе.

    EN:
        Subsection 7.3. Thesis: a forest plot shows effect estimates,
        confidence intervals, and study weights in meta-analysis.
    """
    ...
    ax.errorbar(
        ...
        y,
        xerr=[
            plot_df["risk_ratio"] - plot_df["ci_low"],
            plot_df["ci_high"] - plot_df["risk_ratio"],
        ],
        fmt="o",
        capsize=3,
        markersize=6,
    ...
    ax.set_title("Forest plot: относительный риск и 95% CI")
