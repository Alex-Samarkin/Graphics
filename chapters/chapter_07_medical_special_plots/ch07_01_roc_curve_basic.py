...
FIGURE_ID = "ch07_01_roc_curve_basic"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 7.1. Тезис: ROC-кривая показывает компромисс между
        чувствительностью и 1-специфичностью при разных порогах теста.

    EN:
        Subsection 7.1. Thesis: the ROC curve shows the trade-off between
        sensitivity and 1-specificity across diagnostic thresholds.
    """
    ...
    ax.plot([0, 1], [0, 1], linestyle="--", color="0.5", label="Случайная классификация")

    ax.set_xlabel("1 − специфичность")
    ax.set_ylabel("Чувствительность")
    ax.set_title("ROC-кривая диагностической модели")
