...
Run:
    uv run python chapters/chapter_09_composite_export/ch09_04_publication_size_one_column.py
...
FIGURE_ID = "ch09_04_publication_size_one_column"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 9.4. Тезис: рисунок нужно проектировать под конечный размер.
        Для одной колонки часто нужен компактный формат с минимумом элементов.

    EN:
        Subsection 9.4. Thesis: a figure should be designed for its final size.
        One-column figures often need compact layout and minimal elements.
    """
