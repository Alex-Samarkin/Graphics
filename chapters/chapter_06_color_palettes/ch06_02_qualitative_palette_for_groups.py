...
Run:
    uv run python chapters/chapter_06_color_palettes/ch06_02_qualitative_palette_for_groups.py
...
FIGURE_ID = "ch06_02_qualitative_palette_for_groups"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 6.2. Тезис: качественная палитра подходит для категорий,
        где цвета не должны задавать ложный порядок.

    EN:
        Subsection 6.2. Thesis: a qualitative palette is suitable for categories
        where colors should not imply a false ordering.
    """
    summary = (
    ...
    ax.set_title("Качественная палитра для групп терапии")
