...
Run:
    uv run python chapters/chapter_06_color_palettes/ch06_04_black_white_print_hatching.py
...
FIGURE_ID = "ch06_04_black_white_print_hatching"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 6.4. Тезис: если рисунок может печататься в чёрно-белом
        виде, различия категорий стоит дублировать штриховкой.

    EN:
        Subsection 6.4. Thesis: if a figure may be printed in grayscale,
        category differences should be duplicated with hatching.
    """
    summary = (
    ...
    ax.set_title("Чёрно-белая совместимость: штриховка")
