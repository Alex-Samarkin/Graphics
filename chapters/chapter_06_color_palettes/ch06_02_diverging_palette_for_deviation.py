...
Run:
    uv run python chapters/chapter_06_color_palettes/ch06_02_diverging_palette_for_deviation.py
...
FIGURE_ID = "ch06_02_diverging_palette_for_deviation"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 6.2. Тезис: дивергентная палитра подходит для отклонений
        относительно нуля или клинического порога.

    EN:
        Subsection 6.2. Thesis: a diverging palette is suitable for deviations
        around zero or around a clinical threshold.
    """
    ...
    ax.set_title("Дивергентная палитра для корреляций")
    fig.tight_layout()
    return fig
