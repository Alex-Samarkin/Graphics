...
Run:
    uv run python chapters/chapter_06_color_palettes/ch06_02_sequential_palette_for_magnitude.py
...
FIGURE_ID = "ch06_02_sequential_palette_for_magnitude"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 6.2. Тезис: последовательная палитра подходит для
        непрерывной величины, например риска или концентрации маркера.

    EN:
        Subsection 6.2. Thesis: a sequential palette is suitable for continuous
        magnitude, such as risk or biomarker concentration.
    """
    ...
    ax.set_title("Последовательная палитра для величины риска")
    sns.despine(ax=ax)
