...
Run:
    uv run python chapters/chapter_11_formats/ch11_02_journal_article_one_column.py
...
FIGURE_ID = "ch11_02_journal_article_one_column"


def build_figure(df: pd.DataFrame) -> plt.Figure:
    """
    RU:
        Подраздел 11.2. Тезис: для статьи в одну колонку рисунок должен быть
        компактным, с короткими подписями и без мелких деталей.

    EN:
        Subsection 11.2. Thesis: for a one-column journal figure, the plot
        should be compact, with short labels and minimal detail.
    """
